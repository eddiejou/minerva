...
ActiveRecord::Schema.define(version: 20170611054351) do
  ...
  create_table "assignment_likes", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "assignment_id"
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
  ...
  create_table "lessons_and_standards", force: :cascade do |t|
    t.integer  "lesson_id"
